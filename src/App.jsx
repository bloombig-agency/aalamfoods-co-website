    ...
    <CartProvider>
      <div className="min-h-screen bg-gray-50 font-sans text-[#1c1917]">
        ...
        <main className="pt-20 lg:pt-24">
          ...
          <section
            id="shop"
            className="py-16 sm:py-20 w-full max-w-[1920px] mx-auto px-4 sm:px-6 md:px-10 lg:px-16 scroll-mt-28"
          >
            <div className="flex flex-col lg:flex-row gap-10 lg:gap-12 items-start">
              ...
              <div className="flex-1 w-full">
                <div className="mb-8 border-b border-gray-100 pb-4">
                  <h2 className="text-3xl md:text-4xl font-serif font-bold text-brand-secondary capitalize tracking-tight">
                ...
                {selectedCategory === "crunch" ? (
                  <div className="bg-white rounded-xl p-10 sm:p-16 lg:p-24 text-center shadow-sm border border-gray-100">
                    <div className="inline-block p-6 bg-brand-light rounded-full mb-6 animate-pulse">
                      <Search className="w-12 h-12 sm:w-16 sm:h-16 text-brand-primary" />
                    </div>
                    ...
                    <p className="text-gray-500 max-w-xl mx-auto text-base sm:text-lg leading-relaxed">
                      We are crafting something crunchy and delicious. Stay
                      tuned for our new addition to the Aalam family.
                    </p>
                  </div>
                  ...
                  <div className="text-center py-16 sm:py-20 bg-white rounded-xl border border-dashed border-gray-300">
                    ...
                    <button
                      ...
                      className="mt-6 text-brand-primary font-medium hover:underline text-base sm:text-lg"
                    >
                      Clear Filters
                    </button>
                  </div>
