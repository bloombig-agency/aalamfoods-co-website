                                ...
                                {cart.map((item) => (
                                    <div key={item.id} className="flex gap-4">
                                        ...
                                        <div className="flex-1">
                                            <h3 className="font-medium text-brand-secondary">{item.name}</h3>
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <p className="font-bold text-brand-secondary">₹{item.price * item.quantity}</p>
                                            </div>
                                        </div>
                                    </div>
                                ))}
                    ...
                    {cart.length > 0 && (
                        <div className="border-t border-gray-100 p-6 bg-gray-50">
                            <div className="flex justify-between items-center mb-4">
                                ...
                                <span className="text-2xl font-bold text-brand-secondary">₹{cartTotal}</span>
                            </div>
                            <button
                                onClick={() => {
                                    setIsCartOpen(false);
