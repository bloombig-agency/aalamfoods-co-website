...
const ProductCard = ({ product }) => {
    ...
    return (
        <div
            className="group relative bg-[#fdfaf5] rounded-xl border border-transparent hover:border-gray-200 transition-all duration-500 ease-in-out p-4 hover:-translate-y-2 hover:shadow-[0_30px_60px_-15px_rgba(0,0,0,0.3)]"
        >
            <div
